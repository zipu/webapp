...
class StockTradeUnit(models.Model):
    ...
    avg_buy_price = models.DecimalField("평균매수단가", max_digits=10, decimal_places=0, default=0, blank=True)
    avg_sell_price = models.DecimalField("평균매도단가", max_digits=10, decimal_places=0, default=0, blank=True)
